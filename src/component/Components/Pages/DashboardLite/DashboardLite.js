  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
      ...
      <Box sx={{
        ...
        <Box sx={{ display: "flex", width: "20%", flexDirection: "column", justifyContent: "space-around" }}>
          <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "center", height: "80%" }}>
            ...
            {login !== "buttons" && <Box sx={{display:"flex",flex:"0 0 auto",boxSizing:"border-box",justifyContent:"center"}}>
              <ReCAPTCHA
          ...
          <Box sx={{ bgcolor: "white", display: "flex", flexDirection: "column", height: "20%" }}>
      ...
      <Box sx={{ width: "95%", position: "sticky", top: "0", zIndex: 99, margin: "0 auto", borderRadius: "10px", display: "flex", flexDirection: "column", bgcolor: "white", boxShadow: '0px 0px 5px #00000030 !important', justifyContent: "space-between" }}>
        <Box sx={{ display: "flex",p: 1, justifyContent: "space-between", width: "100%", mb: 1,height:"100px",overflow:"hidden",transitionDelay: "1s" }} ref={moreButton}>
          <Box sx={{display:"flex",flexWrap:"wrap",m:2,width:"95%",transitionDelay: "1s"}}>
            <Button sx={{bgcolor:"orange",borderRadius:"25px",color: "white" ,m:2,p:1,pr:3,pl:3, fontSize: "1.2rem", ml: 2 }}>{t("nofilter")}</Button>
            <Button sx={{bgcolor:"orange",borderRadius:"25px",color: "white" ,m:2,p:1,pr:3,pl:3, fontSize: "1.2rem" }}>{t("agriculture")}</Button>
            <Button sx={{bgcolor:"orange",borderRadius:"25px",color: "white" ,m:2,p:1,pr:3,pl:3, fontSize: "1.2rem" }}>{t("fabric")}</Button>
            <Button sx={{bgcolor:"orange",borderRadius:"25px",color: "white" ,m:2,p:1,pr:3,pl:3, fontSize: "1.2rem" }}>{t("food")}</Button>
            <Button sx={{bgcolor:"orange",borderRadius:"25px",color: "white" ,m:2,p:1,pr:3,pl:3, fontSize: "1.2rem" }}>{t("apparel")}</Button>
            <Button sx={{bgcolor:"orange",borderRadius:"25px",color: "white" ,m:2,p:1,pr:3,pl:3, fontSize: "1.2rem" }}>{t("electerical")}</Button>
            <Button sx={{bgcolor:"orange",borderRadius:"25px",color: "white" ,m:2,p:1,pr:3,pl:3, fontSize: "1.2rem" }}>{t("electerical")}</Button>
            <Button sx={{bgcolor:"orange",borderRadius:"25px",color: "white" ,m:2,p:1,pr:3,pl:3, fontSize: "1.2rem" }}>{t("electerical")}</Button>
            <Button sx={{bgcolor:"orange",borderRadius:"25px",color: "white" ,m:2,p:1,pr:3,pl:3, fontSize: "1.2rem" }}>{t("electerical")}</Button>
            <Button sx={{bgcolor:"orange",borderRadius:"25px",color: "white" ,m:2,p:1,pr:3,pl:3, fontSize: "1.2rem" }}>{t("electerical")}</Button>
          ...
          <Box sx={{width:"5%",mr: 2, ml: 2 }}>
            {/* <NestedDropdown
              menuItemsData={menuItemsData}
              MenuProps={{ elevation: 3 }}
            /> */}
            <Button variant="outlined" sx={{ color: "black"}} onClick={()=>{moreButton.current.style.height == "auto" ? moreButton.current.style.height = "100px" : moreButton.current.style.height = "auto" }}>
              <ExpandMoreIcon/>
            </Button>
          </Box>
        </Box>
